    ...
    const fetchMessages =
        async (
            ...
            try {
                ...
                const response =
                    await axios.get(
                        `${API_URL}/api/message/${receiverId}`,
                        authConfig
                    );
    ...
    const handleDeleteConversation =
        async (
            ...
            try {
                ...
                await axios.delete(
                    `${API_URL}/api/message/conversation/${conversationId}`,
                    authConfig
                );
                        ...
                        {activeUser ? (
                                    ...
                                    <div className="flex min-w-0 items-center gap-3">
                                        ...
                                        <div className="min-w-0">
                                            ...
                                            <p className="truncate text-[10px] text-gray-400">
                                                ...
                                                {activeUser?.professionalHeadline ||
                                ...
                                <div className="flex items-center gap-3 border-b border-blue-100 bg-blue-50/50 px-5 py-3">
                                    ...
                                    <div className="min-w-0">
                                        ...
                                        <p className="truncate text-[10px] font-semibold text-gray-700">
                                            Connect, ask questions, and share career guidance.
                                        </p>
                                    ...
                                    >
                                        ...
                                        <div className="rounded-xl border border-gray-200 bg-[#F8F9FF] p-2 transition focus-within:border-[#004AC6] focus-within:ring-2 focus-within:ring-blue-100">
                                            ...
                                            <textarea
                                                ...
                                                rows={2}
                                                maxLength={2000}
                                                placeholder={`Write a message to ${getDisplayName(
                                                    activeUser
                                                )}...`}
                                            ...
                                            <div className="flex items-center justify-end border-t border-gray-200/70 pt-2">
                            ...
                            <div className="flex h-full flex-col items-center justify-center bg-[#F8F9FF] px-5 text-center">
                                ...
                                <p className="mt-2 max-w-sm text-xs leading-5 text-gray-400">
                                    Select a conversation from the left to start messaging with your network.
                                </p>
                                                    ...
                                                    .map(
                                                        (
                                                            ...
                                                            <span
                                                                ...
                                                                className="rounded-md bg-blue-50 px-2 py-1 text-[9px] font-semibold text-[#004AC6]"
                                                            >
