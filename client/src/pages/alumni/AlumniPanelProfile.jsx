...
const AlumniPanelProfile = () => {
    ...
    const fetchProfile = async () => {
        ...
        try {
            ...
            /*
             * No userId:
             * logged-in alumni profile
             *
             * userId:
             * another alumni's profile
             */
            ...
            setHeadline(
                fetchedProfile.professionalHeadline ||
                ""
            );

            setAddress(
                fetchedProfile.location?.address ||
                ""
            );

            setCity(
                fetchedProfile.location?.city ||
                ""
            );

            setState(
                fetchedProfile.location?.state ||
                ""
            );

            setCountry(
                fetchedProfile.location?.country ||
                "India"
            );

            setPincode(
                fetchedProfile.location?.pincode ||
                ""
            );
                ...
                const response =
                    await axios.post(
                        `${API_URL.replace(
                            "/api",
                            ""
                        )}/api/auth/verify-member/${memberId}`,
                        {},
                        {
                            headers:
                                getHeaders(),
        ...
        return (
            ...
            <div className="min-h-[70vh] flex items-center justify-center">
                ...
                <div className="text-center">
                    ...
                    <div className="mx-auto h-10 w-10 animate-spin rounded-full border-4 border-blue-100 border-t-[#004AC6]" />
                            ...
                            {isOwnProfile ? (
                                ...
                                <>
                                    ...
                                    {viewedUserId && (
                                        ...
                                        <Link
                                            to={`/alumni/messages?chat=${viewedUserId}`}
                                    ...
                                    {viewedUserId && (
                                        ...
                                        <Link
                                            to={`/alumni/mentorship?request=${viewedUserId}`}
...
export default AlumniPanelProfile;